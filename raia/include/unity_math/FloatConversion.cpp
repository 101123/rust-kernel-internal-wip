...
static void InitializeHalfConversionTables()
{
...
template <auto Func>
struct RunAsGlobalInitializer {
    RunAsGlobalInitializer() {
        Func();
    }
};

RunAsGlobalInitializer<InitializeHalfConversionTables> init;
